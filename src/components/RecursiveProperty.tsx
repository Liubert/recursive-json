...
import { camelCaseToNormal } from '../helpers/utils';
      ...
      {props.property ? (
        typeof props.property === 'number' ||
          ...
          typeof props.property === 'boolean' ? (
            ...
            <ExpandableProperty onLvlUnMount={props.onLvlUnMount} onLvlChange={props.onLvlChange} title={props.propertyNameProcessor!(props.propertyName)} expanded={props.expandAll}>
              {Object.values(props.property).map((property, index, { length }) => (
                <RecursiveProperty
                  onLvlUnMount={props.onLvlUnMount}
                  onLvlChange={props.onLvlChange}
                  key={index}
